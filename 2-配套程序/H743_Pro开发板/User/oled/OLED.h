...
#define OLED_CS_GPIO_CLK_ENABLE()    __GPIOD_CLK_ENABLE()

/*DC引脚*/
#define OLED_DC_PIN                  GPIO_PIN_12                 
#define OLED_DC_GPIO_PORT            GPIOD                      
#define OLED_DC_GPIO_CLK_ENABLE()    __GPIOD_CLK_ENABLE()

/*MOSI引脚*/
#define OLED_SDA_PIN                  GPIO_PIN_13                
#define OLED_SDA_GPIO_PORT            GPIOB                       
#define OLED_SDA_GPIO_CLK_ENABLE()    __GPIOB_CLK_ENABLE()

/*CLK引脚*/
#define OLED_CLK_PIN                  GPIO_PIN_12                
#define OLED_CLK_GPIO_PORT            GPIOB                       
#define OLED_CLK_GPIO_CLK_ENABLE()    __GPIOB_CLK_ENABLE()
/************************************************************/
